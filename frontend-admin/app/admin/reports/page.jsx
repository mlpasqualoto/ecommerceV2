        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-gradient-to-br from-emerald-50 to-green-50 dark:from-emerald-900/20 dark:to-green-900/20 rounded-2xl p-6 border border-emerald-200 dark:border-emerald-800/30 shadow-sm hover:shadow-md transition-all duration-300 animate-fadeInUp">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className={`flex items-center space-x-1 text-xs font-semibold ${String(reportData?.summary?.growth || 0).includes("-") ? 'text-red-600 dark:text-red-400' : 'text-emerald-600 dark:text-emerald-400'}`}>
                {String(reportData?.summary?.growth || 0).includes("-") ? (
                ...
                <span>{String(reportData?.summary?.growth || 0).includes("-") ? reportData?.summary?.growth || 0 : `+${reportData?.summary?.growth || 0}`}%</span>
              </div>
            </div>
