...
export default function ProductsPage() {
  ...
  const handleExportData = () => {
    try {
      ...
      exportButton?.classList.add("bg-green-200", "text-green-700", "dark:text-green-300");
      setTimeout(() => {
        exportButton?.classList.remove("bg-green-200", "text-green-700", "dark:text-green-300");
      }, 2000);
    } catch (error) {
  ...
  const getStatusColor = (status) => {
    const colors = {
      active: "bg-emerald-50 dark:bg-emerald-900/20 text-emerald-700 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800",
      inactive: "bg-amber-50 dark:bg-amber-900/20 text-amber-700 dark:text-amber-300 border border-amber-200 dark:border-amber-800",
      out_of_stock: "bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-800",
      archived: "bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-300 border border-red-200 dark:border-red-800",
      draft: "bg-cyan-50 dark:bg-cyan-900/20 text-cyan-700 dark:text-cyan-300 border border-cyan-200 dark:border-cyan-800",
    };
    return (
      colors[status] || "bg-slate-50 dark:bg-slate-900 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700"
    );
  };
        ...
        <div className="max-w-[1500px] mx-auto px-8 py-8">
          ...
          {editProduct && (
            <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex justify-end z-50 animate-fadeIn">
              <div className="bg-white dark:bg-slate-800 rounded-l-2xl shadow-2xl w-full max-w-xl h-full border-l border-slate-200 dark:border-slate-700 transform animate-slideInRight flex flex-col">

                {/* Cabeçalho fixo */}
                <div className="px-8 py-6 border-b border-slate-200 dark:border-slate-700 flex justify-between items-center">
                  <div>
                    <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100">Editar Produto</h2>
                    <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">ID: {editProduct._id}</p>
                  </div>
                  <button
                    onClick={closeEditModal}
                    className="cursor-pointer bg-red-50 dark:bg-red-900/20 text-red-500 p-2 rounded-full shadow-sm hover:bg-red-100 hover:text-red-600 hover:scale-110 transition-all duration-200"
                    title="Fechar"
                  >
                    ✕
                  </button>
                ...
                <form onSubmit={handleEditSubmit} className="flex-1 overflow-y-auto px-8 py-6 space-y-6">
                  ...
                  >
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border border-slate-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 placeholder:text-slate-300 dark:placeholder:text-slate-600 text-slate-900 dark:text-slate-100 bg-white dark:bg-slate-800 hover:border-slate-300"
                      min="1"
                    />
                  </div>
                  ...
                  {editProduct && (
                    <div>
                      ...
                      <div className="space-y-2 animate-slideInUp">
                        ...
                        <label
                          htmlFor="edit-images"
                          className="flex flex-col items-center justify-center w-full h-40 border-2 border-dashed border-blue-400 rounded-xl cursor-pointer bg-blue-50 dark:bg-blue-900/20 hover:bg-blue-100 dark:hover:bg-blue-900/40 transition-colors duration-200"
                        >
                          <svg
                            className="w-10 h-10 text-blue-500 dark:text-blue-400 mb-2"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                          >
                        ...
                        {editForm.images?.length > 0 && (
                          <div className="mt-4 grid grid-cols-3 gap-3">
                            {editForm.images.map((img, index) => (
                              <div
                                key={index}
                                className="relative w-full h-28 rounded-lg overflow-hidden border border-slate-200 dark:border-slate-700 shadow-sm"
                              >
                                <img
                  ...
                  >
                    ...
                    <select
                      ...
                      onChange={handleEditFormChange}
                      className="w-full px-4 py-3 border border-slate-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-100 hover:border-slate-300"
                    >
          ...
          {isCreateModalOpen && (
            <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex justify-end z-50 animate-fadeIn">
              <div className="bg-white dark:bg-slate-800 rounded-l-2xl shadow-2xl w-full max-w-xl h-full border-l border-slate-200 dark:border-slate-700 transform animate-slideInRight flex flex-col">
                ...
                <div className="px-8 py-6 border-b border-slate-200 dark:border-slate-700 flex justify-between items-center">
                  <div>
                    <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100">Criar Novo Produto</h2>
                    <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">Adicione um novo produto ao sistema</p>
                  </div>
                  <button
          ...
          {deleteConfirm.open && (
            <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
              <div className="bg-white dark:bg-slate-800 rounded-xl shadow-2xl p-6 max-w-sm w-full animate-fadeIn">
                ...
                <div className="flex justify-end space-x-3">
                  <button
                    ...
                    className="cursor-pointer px-4 py-2 bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-300 rounded-lg hover:bg-slate-200 dark:hover:bg-slate-600 transition"
                  >
                    Cancelar
                  </button>
                  <button
              ...
              <div className="flex flex-col lg:flex-row lg:items-center gap-6">
                ...
                >
                  ...
                  <div className="flex gap-2">
                    <input
                      type="text"
                      name="productId"
                      className="px-4 py-3 border border-slate-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 text-sm font-mono min-w-[200px] placeholder:text-slate-300 dark:placeholder:text-slate-600 text-slate-900 dark:text-slate-100 bg-white dark:bg-slate-800 hover:border-slate-300"
                ...
                >
                  ...
                  <select
                    ...
                    className="px-4 py-3 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 text-sm font-medium min-w-[140px] text-slate-900 dark:text-slate-100 hover:border-slate-300"
                  >
                    <option value="active">Ativo</option>
                    <option value="inactive">Inativo</option>
                    <option value="out_of_stock">Fora de estoque</option>
                    ...
                    products.map((product, idx) =>
                      product ? (
                        <Fragment key={product._id || idx}>
                          ...
                          <tr
                            key={product._id || idx}
                            className="hover:bg-slate-50 dark:hover:bg-slate-700 transition-all duration-200 group animate-fadeInUp"
                          ...
                          >
                            ...
                            <td className="px-6 py-5 text-center">
                              {product.discount && product.discount > 0 ? (
                                <div className="flex flex-col items-center">
                                  ...
                                  <div className="text-[15px] font-bold text-slate-900 dark:text-slate-100 transition-colors duration-200 group-hover:text-emerald-600 dark:group-hover:text-emerald-400">
                                  ...
                                  <div className="flex items-center gap-2 mt-1 text-xs">
                                    ...
                                    <span className="bg-emerald-100 dark:bg-emerald-900/40 text-emerald-700 dark:text-emerald-300 font-semibold px-2 py-0.5 rounded-full text-[11px]">
                                      -{product.discount}%
                                    </span>
                                  </div>
                                </div>
                            ...
                            <td className="px-6 py-5 text-center">
                              <span className="inline-flex items-center justify-center w-8 h-8 bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-300 text-sm font-bold rounded-full transition-all duration-200 group-hover:bg-blue-100 dark:group-hover:bg-blue-900/40 group-hover:text-blue-700 dark:group-hover:text-blue-300">
                                {product.stock}
                              </span>
                            </td>
                            ...
                            <td className="px-6 py-5">
                              <div className="flex items-center justify-center gap-1">
                                <button
                                  className="cursor-pointer p-2 text-blue-600 dark:text-blue-400 hover:text-blue-800 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-lg transition-all duration-200 transform hover:scale-110"
                                ...
                                <button
                                  className="cursor-pointer p-2 text-red-600 hover:text-red-800 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-all duration-200 transform hover:scale-110"
                            ...
                            <td className="px-6 py-5 text-center">
                              <button
                                className="cursor-pointer p-2 text-slate-600 dark:text-slate-400 hover:text-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 rounded-lg transition-all duration-200 transform hover:scale-110"
                          ...
                          {expandedProduct === product._id && (
                            <tr
                              ...
                              className="bg-slate-50 dark:bg-slate-900 animate-slideDown"
                            >
                              <td colSpan="6" className="px-6 py-6">
                                <div className="bg-white dark:bg-slate-800 rounded-xl p-6 border border-slate-200 dark:border-slate-700 animate-fadeIn">
                                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                    ...
                                    <div
                                      ...
                                      style={{ animationDelay: "0.1s" }}
                                    >
                                      <h4 className="font-semibold text-slate-900 dark:text-slate-100 text-sm uppercase tracking-wide border-b border-slate-200 dark:border-slate-700 pb-2">
                                        Informações do Produto
                                      </h4>
                                      <div className="space-y-3">
                                        <div>
                                          <label className="text-xs font-medium text-slate-500 dark:text-slate-500 uppercase tracking-wide">
                                            ID
                                          </label>
                                      ...
                                      <div className="space-y-3">
                                        ...
                                        <div>
                                          ...
                                          <div className="flex items-center gap-2">
                                            ...
                                            <p>
                                              {product.discount && product.discount > 0 ? (
                                                <span className="text-sm text-slate-500 dark:text-slate-500 line-through mr-2">
                                                  {formatCurrencyBRL(product.price)}
                                                </span>
                                              ) : null}
                                            </p>
                                  ...
                                  <div className="mt-6 pt-6 border-t border-slate-200 dark:border-slate-700">
                                    <h4 className="font-semibold text-slate-900 dark:text-slate-100 text-sm uppercase tracking-wide mb-4">
                                      Ações Rápidas de Status
                                    </h4>
                                    <div className="flex flex-wrap gap-2">
                                      <button
                                        className="cursor-pointer px-4 py-2 bg-emerald-100 dark:bg-emerald-900/40 text-emerald-700 dark:text-emerald-300 hover:bg-emerald-200 rounded-lg transition-all duration-200 text-sm font-medium flex items-center gap-2 transform hover:scale-105"
                                        onClick={() =>
                                          handleStatusProduct(
                                            product._id,
                                            "active"
                                      ...
                                      >
                                        ...
                                        >
                                          ...
                                          />
                                          <path d="M8 1a2.5 2.5 0 0 1 2.5 2.5V4h-5v-.5A2.5 2.5 0 0 1 8 1m3.5 3v-.5a3.5 3.5 0 1 0-7 0V4H1v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V4zM2 5h12v9a1 1 0 0 1-1 1H3a1 1  0 0 0-1-1z" />
                                      </svg>
                                      Ativar
                                    </button>

                                    <button
                                      className="cursor-pointer px-4 py-2 bg-amber-100 dark:bg-amber-900/40 text-amber-700 dark:text-amber-300 hover:bg-amber-200 rounded-lg transition-all duration-200 text-sm font-medium flex items-center gap-2 transform hover:scale-105"
                                      onClick={() =>
                                        handleStatusProduct(
                                          product._id,
                                          "inactive"
                                    ...
                                    <button
                                      className="cursor-pointer px-4 py-2 bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-300 hover:bg-blue-200 rounded-lg transition-all duration-200 text-sm font-medium flex items-center gap-2 transform hover:scale-105"
                                      onClick={() =>
                                        handleStatusProduct(
                                          product._id,
                                          "out_of_stock"
                                    ...
                                    <button
                                      className="cursor-pointer px-4 py-2 bg-red-100 dark:bg-red-900/40 text-red-700 dark:text-red-300 hover:bg-red-200 rounded-lg transition-all duration-200 text-sm font-medium flex items-center gap-2 transform hover:scale-105"
                                      onClick={() =>
                                        handleStatusProduct(
                                          product._id,
                                          "archived"
