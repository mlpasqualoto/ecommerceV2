...
export const createProduct = async (req, res) => {
  try {
    ...
    res
      .status(201)
      .json({ message: "Produto criado com sucesso", product: savedProduct });
  } catch (err) {
    res
      .status(400)
...
export const deleteProductImage = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ message: "Erro ao remover imagem", error: e.message });
  }
};
...
export const getProductById = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Erro ao obter produto", error: err.message });
  }
};
